...
for r=1:NRegs
     ...
     ScenarioParams.vHat3PhaseRegs{ml,1}(r,Network.Branch.Phases{l})=(inv(Av)*ScenarioParams.vHat3Phase{ml,1}(n,Network.Branch.Phases{l}).').'; % three phases
     Network.w3PhaseRegs(r,Network.Branch.Phases{l})=(inv(Av)*ScenarioParams.w3Phase{ml}(n,Network.Branch.Phases{l}).').';
end
