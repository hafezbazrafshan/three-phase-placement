...
NoDgRow={F,  Approach, CompTime,PlObj, SiObj, SiObjCr,Gap,  FiCost, SeCost, ElCost, CuCost,SumpR, NoDGs, MaxpR, MinpR, AvgDCToAC,...
...
% 
% 
% MisocpRow={F, Approach,CompTime,PlObj, SiObj, SiObjCr,Gap,  FiCost, SeCost, ElCost, CuCost,SumpR,AvgDCToAC,...
%     DVmax, ValTotCost,ValElCost,ValCuCost,ValDVmax,Savings};
% 
...
SocpRow={F, Approach,CompTime,PlObj, SiObj, SiObjCr,Gap,  FiCost, SeCost, ElCost, CuCost,SumpR,NoDGs, MaxpR, MinpR, AvgDCToAC,...
    DVmax, ValTotCost,ValElCost,ValCuCost,ValDVmax,Savings};
...
% 
% 
% CsdpRow={F, Approach, CompTime,PlObj, SiObj, SiObjCr,Gap,  FiCost, SeCost, ElCost, CuCost,SumpR, AvgDCToAC,...
%     DVmax, ValTotCost,ValElCost,ValCuCost,ValDVmax,Savings};
% RowNames=[RowNames;FileName];
