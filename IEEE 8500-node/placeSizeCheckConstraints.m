Budget1PhiConstraints=sum(b1Phi)-B1Phi; 
Budget3PhiConstraints=sum(b3Phi)-B3Phi;
b1PhiLowerConstraints=0-b1Phi;
b1PhiHigherConstraints=b1Phi-1;
b3PhiLowerConstraints=0-b3Phi;
b3PhiHigherConstraints=b3Phi-1; 
...
pRsR1PhiConstraints=pR1Phi-DCToACRatio.*sR1Phi;
pRsR3PhiConstraints=pR3Phi-DCToACRatio.*sR3Phi;
...
Constraints=v2struct(Budget1PhiConstraints,Budget3PhiConstraints, ...
    b1PhiLowerConstraints, b1PhiHigherConstraints,...
    b3PhiLowerConstraints, b3PhiHigherConstraints,...
