...
Wnn3Phi(:,:,Bus.ThreePhaseBusNumbers==Bus.SubstationNumber)==ScenarioParams.vS{ml}*ScenarioParams.vS{ml}';
...
for l=1:NBranches
    ...
    elseif length(Branch.Phases{l})==2
      ...
      WnmPrimeTilde=cvx(zeros(3));
        ...
        WnnPrimeTilde(Branch.Phases{l},Branch.Phases{l})=WnnPrime3Phi(:,:,rr,ms);
        WnmPrimeTilde(Branch.Phases{l},Branch.Phases{l})=WnmPrime3Phi(:,:,rr,ms); 
